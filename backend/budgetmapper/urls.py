...
gov_router = routers.NestedDefaultRouter(router, r"governments", lookup="government")
gov_router.register(r"default-budget", views.DefaultBudgetView, basename="government-default-budget")
...
urlpatterns = [
    ...
    path("api/v1/", include(gov_router.urls)),
